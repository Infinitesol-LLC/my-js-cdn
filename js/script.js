...
const inputField = document.getElementById('chatInputInitial');
 
chips.forEach(btn => {
  btn.addEventListener('click', () => {
    inputField.value = btn.textContent.trim();
    inputField.focus();
  });
});
...
// Chip click → type question into input
chips.forEach(chip => {
...
function handleSend() {
  ...
  const btn = document.getElementById('handleSendMessageInitial');
...
// Button click event
document.getElementById('handleSendMessageInitial')
